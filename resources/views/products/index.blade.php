    ...
    <div class="breadcrumb-area">
        <div class="container">
            <ol class="breadcrumb breadcrumb-list">
                ...
                ]) }}">{{ __('products.breadcrumb_home') }}</a></li>
                <li class="breadcrumb-item active">{{ __('products.breadcrumb_products') }}</li>
            </ol>
        </div>
    </div>
            ...
            <form action="{{ route('products') }}" method="GET">
                <div class="row">
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        ...
                        @else
                            @if (!empty($settings['products_hero']))
                                <div class="hero-img">
                                    <img data-src="{{ asset('storage' . $settings['products_hero']) }}" alt="Hero Image"
                                        class="lazy img-fluid hero-img">
                                </div>
                            @else
                                <div class="alert alert-info">
                                    Product Hero Image have not been added yet, input in CMS
                                </div>
                            @endif
                            ...
                            <div class="row">
                                @foreach ($categories as $category)
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                                        <div class="grid-category pb-5 text-center">
                                            <a
                                                href="{{ route('categories.showBySlug', ['slug' => $category['slug'], 'locale' => app()->getLocale()]) }}">
                                                @if (!empty($category['image']))
                                                    <img data-src="{{ asset('storage' . $category['image']) }}"
                                                        alt="{{ $category['name'] }}" class="square-image lazy">
                                                @else
                                                    <img data-src="https://via.placeholder.com/300x300"
                                                        alt="{{ $category['name'] }}" class="square-image lazy">
                                                @endif
                                        ...
                                        @foreach ($products as $p)
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                                ...
                                                <div class="single-elomous-product">
                                                    <!-- Product Image Start -->
                                                    <div class="pro-img">
                                                        <a href="{{ route('products.showBySlug', [
                                                            'slug' => $p['slug'],
                                                            'locale' => app()->getLocale(),
                                                        ]) }}">
